    ...
    return (
      <div className="App">
        ...
        <div className='site-statistics'>
          <img src='https://i0.wp.com/www.protocolbloggerspoint.com/wp-content/uploads/2018/05/350x215-FEAT-in-post-Event-Statistics-post.jpg?w=953(19 kB)' />
          <div>
            <h1>Number of events:<br />{this.props.eventlist.length}</h1>
